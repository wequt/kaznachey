            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-8 space-y-8">
                    ...
                    <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
                        <div
                            class="p-8 border-b border-slate-50 flex justify-between items-center bg-linear-to-r from-white to-slate-50">
                            <div>
                                <h3 class="text-lg font-bold text-slate-800">Последняя активность</h3>
                            </div>
                            <div class="text-right">
                                <p class="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Доступно
                                    средств</p>
                        ...
                        <div class="divide-y divide-slate-50">
                            <div v-for="tx in recentTransactions" :key="tx.id"
                                class="p-6 flex items-center justify-between hover:bg-slate-50/50 transition">
                                <div class="flex items-center gap-5">
                                    ...
                                    <div>
                                        <p class="font-bold text-slate-800">
                                            {{ tx.destination_account_id ? 'Внутренний перевод' : (tx.description ||
                                                tx.category?.name) }}
                                        </p>
                                        <div class="flex items-center gap-2 text-xs text-slate-400 mt-0.5">
                                            <template v-if="tx.destination_account_id">
                                                ...
                                                <span>→</span>
                                                <span
                                                    class="bg-amber-50 px-2 py-0.5 rounded text-amber-800 font-medium">{{
                ...
                <div class="lg:col-span-4 space-y-6">
                    <div class="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm">
                        ...
                        <div class="relative h-56 mb-8">
                            ...
                            <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                                <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Траты
                                    (мес.)</span>
                    ...
                    <div
                        class="bg-[#A66353] p-8 rounded-3xl text-white shadow-xl shadow-[#a663532c] relative overflow-hidden group">
                        <div class="relative z-10">
                            <h4 class="text-lg font-bold mb-2">Планирование</h4>
                            <p class="text-sm text-[#F3D9D4] mb-6 leading-relaxed">Установите лимиты на категории, чтобы
                                система
                                предупредила о перерасходе.</p>
                            <Link href="/budgets"
                                class="inline-flex items-center gap-2 bg-white text-[#A66353] px-6 py-3 rounded-xl font-bold text-sm hover:bg-slate-50 transition-colors">
                                Настроить лимиты
